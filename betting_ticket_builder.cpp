...
#include "betting_ticket_builder.h"
    ...
    betting_ticket_builder&  betting_ticket_builder:: bet1(bet& x,std::string teamname) {
        bt.bet1 = x;
    ...
    betting_ticket_builder&  betting_ticket_builder:: bet2(bet& x,std::string teamname) {
        bt.bet2 = x;
        if(teamname==x.getteam1())
            bt.totalbettingodds*=x.getbot1();
        else if (teamname==x.getteam2())
    ...
    betting_ticket_builder&  betting_ticket_builder:: bet3(bet& x,std::string teamname) {
        bt.bet3 = x;
        if(teamname==x.getteam1())
            bt.totalbettingodds*=x.getbot1();
        else if (teamname==x.getteam2())
